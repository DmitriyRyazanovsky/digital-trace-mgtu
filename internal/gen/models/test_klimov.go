...
// ContextValidate validates this test klimov based on context it is used
func (m *TestKlimov) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
